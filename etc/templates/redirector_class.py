...
logfile = "${buildout:directory}/var/log/redirector_class.log"
...
(1, '[\S]*${buildout:fqdn}'): '127.0.0.1:${instance:http-address}/VirtualHostBase/http/${HTTP_HOST}:80/${shared:portal-name}/VirtualHostRoot',
